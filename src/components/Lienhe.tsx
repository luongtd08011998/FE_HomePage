  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-br from-[#e0f2fe] via-[#f8fafb] to-[#dbeafe]" />
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle at 20% 50%, rgba(14, 165, 233, 0.15) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(56, 189, 248, 0.15) 0%, transparent 50%)",
          }}
        />
            ...
            <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-[#0ea5e9] to-[#0284c7] flex items-center justify-center shadow-lg shadow-blue-200">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M12 3c-1.657 0-3 1.343-3 3 0 1.657 1.343 3 3 3s3-1.343 3-3c0-1.657-1.343-3-3-3zm-7 7c-1.657 0-3 1.343-3 3 0 1.657 1.343 3 3 3s3-1.343 3-3c0-1.657-1.343-3-3-3zm14 0c-1.657 0-3 1.343-3 3 0 1.657 1.343 3 3 3s3-1.343 3-3c0-1.657-1.343-3-3-3zm-7 7c-1.657 0-3 1.343-3 3 0 1.657 1.343 3 3 3s3-1.343 3-3c0-1.657-1.343-3-3-3z"
                />
              </svg>
            </div>
          </motion.div>
          ...
          {contactInfo.map((item, index) => (
            ...
            >
              <div className="relative h-full bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-lg shadow-blue-100/50 border border-[#e0f2fe] hover:shadow-xl hover:shadow-blue-200/60 transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-[#0ea5e9]/0 via-[#38bdf8]/0 to-[#0ea5e9]/0 group-hover:from-[#0ea5e9]/20 group-hover:via-[#38bdf8]/10 group-hover:to-[#0ea5e9]/20 transition-all duration-500 pointer-events-none" />
                ...
                <div className="relative">
                  ...
                  {item.link ? (
                    ...
                    <>
                      <p className="text-[#0a1628] mb-1">{item.content}</p>
                      {item.subtitle && (
                        <p className="text-sm text-[#64748b]">
                          {item.subtitle}
                        </p>
